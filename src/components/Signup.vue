<template>
  <div class="grid grid-cols-1 gap-x-8 items-stretch px-28 -mt-10 h-screen">
    <div class="grid content-center">
      <h1 class="mb-8 text-3xl font-bold">Create a new account</h1>
      ...
      />
      <div class="mb-4">
        <input v-model="signupForm.welcomeEmail" type="checkbox" name="welcomeEmail" class="mr-2" />
        <label class="text-sm" for="welcomeEmail">Send me a welcome email</label>
      </div>
      <button
        class="py-2 w-full text-white bg-blue7 hover:bg-blue6"
      ...
      <GoogleSignIn v-if="googleEnabled === 'true'" @on-submit="handleResponse">
